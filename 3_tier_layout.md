...
**[Note]** Most solutions I have seen to this project use a NAT gateway to link the public and private subnets. While a NAT gateway will allow transactions between the public and private subnets it can be a bit of an "all or nothing" blunt tool. **Also, AWS charge for using a NAT gateway.** 
